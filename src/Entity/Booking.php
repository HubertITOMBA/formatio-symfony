...
class Booking
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Ad", inversedBy="startDate")
     * @ORM\JoinColumn(nullable=false)
     */
    private $ad;
...
public function isBookableDates() {
    // 1 Identifier les dates impossibles
    $notAvailableDays = $this->ad->getNotAvailableDays();
    // 2 Comparer les dates choisies et les dates impossibles
    $bookingDays = $this->getDays();

    // Tableau des chaines de caractères de journées
...
/**
 * Permet de récupérer un tableau des journées qui correcpondent à la réservation
